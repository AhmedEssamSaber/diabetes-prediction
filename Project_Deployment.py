...
data = pickle.load(open(r"D:\AI\projects\diabetes\Diabetes.sav", 'rb'))
        ...
        try:
            ...
            with st.sidebar:
                if result[0] == 0:
                    ...
                    st.image(r"D:\AI\projects\diabetes\Screenshot 2024-10-24 130623.png", width=300)
                else:
                    st.error('The Patient Has Diabetes')
                    st.image(r"D:\AI\projects\diabetes\Screenshot 2024-10-22 231216.png", width=300)
